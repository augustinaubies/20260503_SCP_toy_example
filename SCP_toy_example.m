...
for i_time = 1:numel(sim_time)
    ...
    [ctrl_time, ctrl_values, updated_ctrls] = get_ctrl_values(current_time, X_k, time_since_last_ctrl, SCP_param, get_all_operators);
    if updated_ctrls
...
function [ctrl_time, ctrl_values, updated_ctrls] = get_ctrl_values(current_time, current_states, time_since_last_ctrl, SCP_param, get_all_operators)
    % ctrl time : [t0;t1;...;t_N]
